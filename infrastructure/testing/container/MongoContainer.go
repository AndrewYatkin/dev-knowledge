...
import (
	...
	mongoTestUtil "dev-knowledge/infrastructure/mongo/test/util"
	"fmt"
...
func (c *MongoContainer) NewMongoRepository(dbName string) *commonMongo.MongoRepository {
